!(function (e, t) {
    if (typeof exports == 'object' && typeof module == 'object') module.exports = t()
      ...
      var i = t()
      for (var o in i)(typeof exports == 'object' ? exports : e)[o] = i[o]
    }
  }(this, function () {
    return (function (e) {
      function t (o) {
      ...
      function o (e) {
        ...
        var t = {}
        if (e != null) { for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (t[i] = e[i]) }
      ...
      t.IS_ENABLED_FLASH = (function () {
        ...
        return window.MediaSource = window.MediaSource || window.WebKitMediaSource, window.MediaSource && typeof window.MediaSource.isTypeSupported == 'function' && window.MediaSource.isTypeSupported('video/mp4; codecs="avc1.42E01E,mp4a.40.2"')
      }())
    }, function (e, t) {
      'use strict'
      ...
      function l (e) {
        ...
        var t = 3600,
          ...
          n = (e - o * t) / i | 0,
          r = e - o * t - n * i
        return o = o > 0 ? o + ':' : '', n = n > 0 ? n + ':' : '00:', r = r > 0 ? r + '' : o.length > 0 || n.length > 0 ? '00' : '00:00', o = o.length == 2 ? '0' + o : o, n = n.length == 2 ? '0' + n : n, r = r.length == 1 ? '0' + r : r, o + n + r
      }
      ...
      function c (e, t) {
        m.off(t.video.el, 'webkitbeginfullscreen', c), e.type == 'webkitbeginfullscreen' ? (m.on(t.video.el, 'webkitendfullscreen', function (e) {
          c(e, t)
        }), b.pub({
          type: g.MSG.FullScreen,
          src: 'util',
        ...
        }, p.player)) : e.type == 'webkitendfullscreen' && (m.off(t.video.el, 'webkitendfullscreen', c), b.pub({
          type: g.MSG.FullScreen,
          src: 'util',
          ts: e.timeStamp,
          detail: {
      ...
      function u (e) {
        e.keyCode === 27 && p(p.player, !1)
      }
  
      function p (e, t, i) {
        if (typeof t == 'undefined') return p.__isFullscreen || !1
      ...
      if (O) { for (var P = 0; P < O.length; P++) S[M[P]] = O[P] }
   ...
   if (i !== '*') {
              ...
              c.length == 0 && delete s[a][i.guid], p.isEmpty(s[a]) && delete s[a]
            } else {
      ...
      t.Player = (function () {
        ...
        return e.prototype.render = function (e) {
          ...
          this.poster = new E['default'](this), this.poster.render(this.el), (T.IS_SAFARI && parseInt(T.SAFARI_VERSION) > 10 || T.IOS_VERSION > 10) && this.options.controls == 'system' || (this.bigplay = new w['default'](this), this.bigplay.render(this.el))
          var n = void 0
          n = !(this.options.controls && this.options.controls != 'default' && (!this.options.flash || this.options.controls != 'system')), n && (this.panel = new b['default'](this), this.panel.render(this.el)), this.setup()
      ...
      function r (e, t) {
        var i = v(),
          o = b[b.length - 1]
        if (e.insertAt === 'top') o ? o.nextSibling ? i.insertBefore(t, o.nextSibling) : i.appendChild(t) : i.insertBefore(t, i.firstChild), b.push(t)
        else {
      ...
      function c (e, t) {
        ...
        if (t.singleton) {
          ...
          e.sourceMap && typeof URL == 'function' && typeof URL.createObjectURL == 'function' && typeof URL.revokeObjectURL == 'function' && typeof Blob == 'function' && typeof btoa == 'function' ? (i = a(t), o = h.bind(null, i), n = function () {
      ...
      var d = {},
        f = function (e) {
          var t
          return function () {
            return typeof t == 'undefined' && (t = e.apply(this, arguments)), t
          }
        },
        y = f(function () {
      ...
      e.exports = function (e, t) {
        t = t || {}, typeof t.singleton == 'undefined' && (t.singleton = y()), typeof t.insertAt == 'undefined' && (t.insertAt = 'bottom')
        var i = n(e)
        return o(i, t),
        function (e) {
        ...
        w = (function (e) {
          ...
          return l(t, e), t.prototype.render = function (t) {
            var i, o = this.player.options,
              n = o.controls == 'system' ? '' : null,
              r = !!o.autoplay || null
            return i = o.poster && a(o.poster) == 'object' ? o.poster.src : typeof o.poster == 'string' ? o.poster : null, this.createEl('video', {
              controls: n,
              preload: o.preload || 'auto',
              autoplay: r,
              'webkit-playsinline': '',
              ...
              'x5-video-player-type': o.x5_type == 'h5' ? 'h5' : null,
            ...
            })), t.on(flvjs.Events.STATISTICS_INFO, f.bind(this, function (e, t) {})), this.flv = t, t.load()
            ...
            if (!b.IS_ENABLED_MSE || !i && !o || b.IS_X5TBS && this.player.options.x5_player || i && b.IS_MAC && b.IS_SAFARI && !b.IS_IOS) this.__type = t, this.el.src = e
              ...
              i ? (this.__type = f.VideoType.M3U8, typeof window.Hls == 'undefined' ? h.loadScript(f.CDNPath + r, function () {
                n.__hlsLoaded.call(n, e)
              }) : this.__hlsLoaded(e)) : o && (this.__type = f.VideoType.FLV, typeof window.flvjs == 'undefined' ? h.loadScript(f.CDNPath + 'libs/flv.js', function () {
      ...
      var l = i(2),
        ...
        y = (function () {
          ...
          return e.prototype.createEl = function (e, t, i) {
            ...
            typeof e == 'string' && (i = t, t = e, e = this.el), this.cbs = this.cbs || {}
            var o = s(this.guid, i),
              n = !o,
              l = o && !this.fnCache[o]
            ...
            typeof e == 'string' && (i = t, t = e, e = this.el), f.IS_MOBILE && t == 'click' && (t = 'touchend')
            var o = s(this.guid, i)
            ...
            try {
              switch (this.options.debug && this.pub({
                ...
                case 'seekState':
                  ...
                  break
                case 'netStatus':
                  this.options.live || (t.code == 'NetStream.Buffer.Full' ? (this.__prevPlayState == m.PlayStates.PAUSED || this.__prevPlayState == m.PlayStates.STOP, this.__prevPlayState = null) : t.code == 'NetStream.Seek.Complete'), t.code == 'NetConnection.Connect.Closed' && this.options.src.indexOf('rtmp://') > -1 && (this.playState == m.PlayStates.STOP ? (i.type = 'error', t = {
                    code: 13,
                    reason: t.code
                  }) : (i.type = 'error', t = {
                    code: 1002,
                    reason: t.code
                  })), t.code == 'NetStream.Play.Stop'
                  break
                case 'mediaTime':
          ...
          return l(t, e), t.prototype.render = function (t) {
            ...
            switch (e.type) {
              case E.MSG.MetaLoaded:
                this.timeline.percent(this.player.percent()), this.timeline.buffered(this.player.buffered()), this.player.volume(typeof this.options.volume == 'undefined' ? 0.5 : this.options.volume), !this.options.autoplay && this.show()
                break
      ...
      var a = i(11),
        ...
        y = (function (e) {
          ...
          return l(t, e), t.prototype.render = function (t, i) {
            ...
            }), this.el.appendChild(this.track), this.el.appendChild(this.thumb), this.enabled = typeof i == 'undefined' || i, e.prototype.render.call(this, t)
          }, t.prototype.setup = function () {
          ...
          return l(t, e), t.prototype.render = function (t) {
            ...
            switch (e.type) {
              ...
              case v.MSG.VolumeChange:
                ...
                this.syncTrack(t), t == 0 ? this.syncMute(!0) : t > 0 && this.__muted && this.syncMute(!1)
            }
      ...
      var a = i(11),
        ...
        y = (function (e) {
          ...
          return l(t, e), t.prototype.render = function (t) {
            ...
            this.on('touchstart', this.onClick), this.on('touchend', this.touchstart)
            ...
            this.show == 1 ? (this.container.style.display = 'none',
            this.show = !1) : (this.container.style.display = 'block',
            this.show = !0)
      ...
      var a = typeof Symbol == 'function' && typeof Symbol.iterator == 'symbol' ? function (e) {
        ...
        g = (function (e) {
          function t (i) {
            ...
            return o.options.poster && a(o.options.poster) == 'object' ? o.poster = o.options.poster : typeof o.options.poster == 'string' ? o.poster = {
            ...
            if (e = e || this.poster.src) {
              ...
              t.onload = function () {
                if (i.pic.src = t.src, i.show(), !f.supportStyle('transform')) {
                  var e = i.poster.style == 'stretch'
                  if (e) return
                  var o = i.poster.style == 'cover' ? i.options.width / (t.width / t.height) : t.height,
      ...
      !(function (e, t) {
        ...
        function i (e, t, i, o) {
          var n = ['opacity', t, ~~(100 * e), i, o].join('-'),
            ...
            a = l && '-' + l + '-' || ''
          return h[n] || (u.insertRule('@' + a + 'keyframes ' + n + '{0%{opacity:' + s + '}' + r + '%{opacity:' + e + '}' + (r + 0.01) + '%{opacity:1}' + (r + t) % 100 + '%{opacity:' + e + '}100%{opacity:' + s + '}}', u.cssRules.length), h[n] = 1), n
        }
  
        function o (e, t) {
          var i, o, n = e.style
          if (t = t.charAt(0).toUpperCase() + t.slice(1), void 0 !== n[t]) return t
          for (o = 0; o < p.length; o++) { if (i = p[o] + t, void 0 !== n[i]) return i }
        }
        ...
        function a () {
          ...
          u.addRule('.spin-vml', 'behavior:url(#default#VML)'), l.prototype.lines = function (e, o) {
            ...
            if (o.shadow) { for (a = 1; a <= o.lines; a++) l(a, -2, 'progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)') }
        ...
        if (l.defaults = {}, r(l.prototype, {
          ...
          lines: function (o, r) {
            ...
            for (var a, u = 0, p = (r.lines - 1) * (1 - r.direction) / 2; u < r.lines; u++) {
              a = n(e(), {
                position: 'absolute',
